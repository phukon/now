...
const MonthCard = ({ month, body, color }: MonthProps) => {
  const className = twMerge(
    "bg-[#e36042] flex hover:shadow-md transition-all duration-300 hover:scale-105 flex-col col-span-1 py-5 w-full h-fit md:h-[calc(100%)] overflow-hidden shadow-md",
    color
  );
  return (
    <div className={className}>
      <h1 className="text-4xl mt-[calc(1%)] font-semibold mb-4 text-left w-full --local-basteleur ml-4">
        {month}
      </h1>
