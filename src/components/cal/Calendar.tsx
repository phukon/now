...
import Button from 'components/cal/Button'
import Gallery from 'components/cal/Gallery'
import Modal from 'components/cal/Modal'
import TextBlock from 'components/cal/TextBlock'
...
const Calendar = (props: { data: MonthDataType[] }) => {
  ...
  return (
    <section ref={ref} className="w-full">
      ...
      <section
        className={cn(
          'reveal mx-auto  flex w-full max-w-sm flex-col gap-4 overflow-y-scroll rounded-3xl bg-yellow-400 p-7 shadow-xl',
          bgColors(calBgColor),
          {
